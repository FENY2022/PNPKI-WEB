    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-6 text-sm font-medium">
                ...
                <a href="#roles" class="text-gray-600 hover:text-blue-700 transition duration-150">Roles</a>
            </nav>

            <!-- CTA Button -->
            <a href="#" class="hidden md:inline-flex px-4 py-2 text-sm font-semibold bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition duration-150 shadow-md">
                Log In
            </a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100">
            ...
            <a href="#roles" class="block px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50">Roles</a>
            <a href="#" class="block px-4 py-3 text-sm font-semibold bg-blue-50 text-blue-700 hover:bg-blue-100">Log In</a>
        </div>
    </header>
        ...
        <div class="bg-gradient-to-r from-blue-700 to-blue-900 py-20 sm:py-32">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="#" class="inline-flex justify-center items-center px-8 py-3 text-base font-medium text-white bg-transparent border-2 border-white rounded-xl shadow-lg hover:bg-white hover:text-blue-700 transition duration-200">
                        Request Access
                    </a>
                </div>
            </div>
